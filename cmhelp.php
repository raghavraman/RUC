...
<head>
    ...
    $(document).ready(function() {
        ...
        function display(value) {
            ...
            }else if(value=="ErrorUploadingFile"){
                ...
                <div class="row">
                 ...
                 <div class="user-dashboard">
                    <div class="card" id="addComments">
                        <h4>How did you help your community? </h4>
                        <form action="communityHelp.php" method="post" enctype="multipart/form-data">
                            <textarea class="form-control" name="desc" id="desc" placeholder="For example: Last week I helped pick up trash at the park." required></textarea>
                            <br/> 
