...
<head>
    ...
    var username;
 var textContent = '<div class="card"><section class="post-heading"><div class="row"><div class="col-md-11"><div class="media"><div class="media-left"><a href="VIEWPROFILE"><img class="media-object photo-profile" src="POSTUSERPHOTO" width="40" height="40" alt="..."></a></div><div class="media-body"><a href="VIEWPROFILE" class="anchor-username"><h4 class="media-heading postUser">POSTUSERID</h4></a><a href="#" class="anchor-time">POSTUSERNEIGHBOURHOOD</a></div></div></div></div></section><section class="post-body"><p id="timestamp">TIMESTAMP</p><p id="postDescription">POSTDESCRIPTION</p></section><section class="post-footer"><hr><div class="post-footer-option"><ul class="list-unstyled"><li><a onclick="addLikes(POSTADDLIKES,this);" LIKESTYLE"><i class="glyphicon glyphicon-thumbs-up"></i> <span id ="POSTLIKEID" >POSTLIKES</span></a></li><li><a onclick="addDisLikes(POSTADDDISLIKES,this);" DISLIKESTYLE><i class="glyphicon glyphicon-thumbs-down"></i><span id ="POSTDISLIKEID" >POSTDISLIKES</span></a></li><li><a href="COMMENTSURL"><i class="glyphicon glyphicon-comment"></i> POSTCOMMENTS</a></li></ul></div></section></div>';

    var imageContent='<div class="card"><section class="post-heading"><div class="row"><div class="col-md-11"><div class="media"><div class="media-left"><a href="VIEWPROFILE"><img class="media-object photo-profile" src="POSTUSERPHOTO" width="40" height="40" alt="..."></a></div><div class="media-body"><a href="VIEWPROFILE" class="anchor-username"><h4 class="media-heading postUser">POSTUSERID</h4></a><a href="#" class="anchor-time">POSTUSERNEIGHBOURHOOD</a></div></div></div></div></section><section class="post-body"><div class="imgPost"><p id="timestamp">TIMESTAMP</p><img src="IMGURL" height="50px" class="img-responsive imgContent"></div><div class="postDescription"><p id="postDescription" class="postDescription">POSTDESCRIPTION</p></div></section><section class="post-footer"><hr><div class="post-footer-option"><ul class="list-unstyled"><li><a onclick="addLikes(POSTADDLIKES,this);" LIKESTYLE"><i class="glyphicon glyphicon-thumbs-up"></i> <span id ="POSTLIKEID" >POSTLIKES</span></a></li><li><a onclick="addDisLikes(POSTADDDISLIKES,this);" DISLIKESTYLE><i class="glyphicon glyphicon-thumbs-down"></i><span id ="POSTDISLIKEID" >POSTDISLIKES</span></a></li><li><a href="COMMENTSURL"><i class="glyphicon glyphicon-comment"></i> POSTCOMMENTS</a></li></ul></div></section></div>';

    var audioContent='<div class="card"><section class="post-heading"><div class="row"><div class="col-md-11"><div class="media"><div class="media-left"><a href="VIEWPROFILE"><img class="media-object photo-profile" src="POSTUSERPHOTO" width="40" height="40" alt="..."></a></div><div class="media-body"><a href="VIEWPROFILE" class="anchor-username"><h4 class="media-heading postUser">POSTUSERID</h4></a><a href="#" class="anchor-time">POSTUSERNEIGHBOURHOOD</a></div></div></div></div></section><section class="post-body"><div class="audioPost"><p id="timestamp">TIMESTAMP</p><audio src="AUDIOURL" controls></div><div class="postDescription"><p id="postDescription" class="postDescription">POSTDESCRIPTION</p></div></section><section class="post-footer"><hr><section class="post-footer"><hr><div class="post-footer-option"><ul class="list-unstyled"><li><a onclick="addLikes(POSTADDLIKES,this);" LIKESTYLE"><i class="glyphicon glyphicon-thumbs-up"></i> <span id ="POSTLIKEID" >POSTLIKES</span></a></li><li><a onclick="addDisLikes(POSTADDDISLIKES,this);" DISLIKESTYLE><i class="glyphicon glyphicon-thumbs-down"></i><span id ="POSTDISLIKEID" >POSTDISLIKES</span></a></li><li><a href="COMMENTSURL"><i class="glyphicon glyphicon-comment"></i> POSTCOMMENTS</a></li></ul></div></section></div>';

    var videoContent='<div class="card"><section class="post-heading"><div class="row"><div class="col-md-11"><div class="media"><div class="media-left"><a href="VIEWPROFILE"><img class="media-object photo-profile" src="POSTUSERPHOTO" width="40" height="40" alt="..."></a></div><div class="media-body"><a href="VIEWPROFILE" class="anchor-username"><h4 class="media-heading postUser">POSTUSERID</h4></a><a href="#" class="anchor-time">POSTUSERNEIGHBOURHOOD</a></div></div></div></div></section><section class="post-body"><div class="videoPost"><p id="timestamp">TIMESTAMP</p><video width="400" src="VIDEOURL" controls> </video></div><div class="postDescription"><p id="postDescription" class="postDescription">POSTDESCRIPTION</p></div></section><section class="post-footer"><hr><div class="post-footer-option"><ul class="list-unstyled"><li><a onclick="addLikes(POSTADDLIKES,this);" LIKESTYLE"><i class="glyphicon glyphicon-thumbs-up"></i> <span id ="POSTLIKEID" >POSTLIKES</span></a></li><li><a onclick="addDisLikes(POSTADDDISLIKES,this); DISLIKESTYLE"><i class="glyphicon glyphicon-thumbs-down"></i><span id ="POSTDISLIKEID" >POSTDISLIKES</span></a></li><li><a href="COMMENTSURL"><i class="glyphicon glyphicon-comment"></i> POSTCOMMENTS</a></li></ul></div></section></div>';
    function getdetails(){
        $(document).ready(function() {
			...
			t=t.replace("TIMESTAMP",a.timestamp);
    ...
    function addLikes(postId, elem){
         var dislike = elem.parentElement.parentElement.children[1].children[0]
         dislike.style.color="";
         var like = elem.parentElement.parentElement.children[0].children[0]
    ...
    function addDisLikes(postId,elem){
         var dislike = elem.parentElement.parentElement.children[1].children[0]
         if(dislike.style.color=="blue"){
            dislike.style.color="";   
         }else{
            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li><a href="Help.php"><i class="fa fa-info" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Help</span></a></li>
                    </ul>
                </div>
            </div>
