                ...
                if ($conn->query($sql) === TRUE) {
                    ...
                    if ($conn1->query($sql) === TRUE) {
                        ...
                        if ($conn4->query($sql) === TRUE) {
							...
							$challenge_success_post->user_id = $current_user->user_id;
							$challenge_success_post->desc_text = $approved_query->user_name ." successfully completed my challenge and got " .$points ." points";
