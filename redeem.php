...
<head>
    ...
    $(document).ready(function() {
		...
		var x = document.forms["buyreward"]["no_of_referral"].value;
		if (x <= 0) {
        alert("You can't buy negative or zero referrals");
        return false;
		}
		}
		function update(elem){
			$('#refcost').val(elem.value * 4);
		}
                ...
                <div class="row">
                 ...
                 <div class="user-dashboard">
                    <div class="card" id="addComments">
                        <h4><b>Buy referrals<b></h4>
                        <form name = "buyreward" action="redemption_handler.php" onsubmit = "return validateForm()" method="post" enctype="multipart/form-data">
                            <br/>
							<label><h4>Number of referrals you want to buy</h4></label><br/>
							<input type="number" name="no_of_referral" placeholder="0" min="1" value="0" id = "refs" required onchange="update(this);"><br>
                            <br/>
							<label><h4>Cost in Points: </h4></label><br/>
                            ...
                            <div class='pull-right postCardSubmit'>
                                <input type="submit" class='btn btn-primary .btn-large' value="REDEEM" name="submit">
                            </div>
                        </form>
                    </div>
                </div>
