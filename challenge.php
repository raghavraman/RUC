...
<head>
              ...
              success: function(response){
                ...
                challenges=response["challenges"];
                 challenges.forEach(function(response){
                    ...
                    t=t.replace("CHALLENGEDURATION",response.duration)
    ...
    function acceptChallenge(id) {
        var jsonobj = {"to_call": "put_accept_challenges_data","challenge_id": id}
        $.ajax({
              type: "POST",
              url: "challenges_handler.php",
              data: { challenge_info: JSON.stringify(jsonobj)},
    ...
    function createChallenge(){
        if(!$("#challenge_title").val()){
            alert("Please enter a title for the challenge");
            return;
        }
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
               ...
               <div class="user-dashboard">
                     <div class="challengenavbar">
                      <ul>
                        <li class="activechallenge"><a href="challenge.php">Open Challenges</a></li>
