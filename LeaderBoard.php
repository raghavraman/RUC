                    ...
                    if(response.code == 200)
                    {
                        ...
                        data_.forEach(function(a){
                            ...
                            var data1="<div class=\"card\" style=\"display: block; height: 20%; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);\n" +
                                ...
                                "                        <a href='viewProfile.php?user_id="+id+"'> <img src='"+photo+"' height=\"50\" width=\"50\" /></a>\n" +
                                "                     </div>\n" +
...
<div class="container-fluid display-table">
    <div class="row display-table-row">
        <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
            ...
            <div class="navi">
                <ul>
                    ...
                    <li class="active"><a href="LeaderBoard.php"><i class="fa fa-users" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Leaderboard</span></a></li>
        ...
        <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <header>
                    <div class="col-md-7">
                        ...
                        <div class="search hidden-xs hidden-sm">
                            <a href="Help.php#leaderboard"><h2><b>Leaderboard</b></h2></a>
                        </div>
                    </div>
                    <div class="col-md-5">
            ...
            margin-top: 10px">
                    <div class='row'>
                        <div class='col-md-1 col-xs-3' style="padding-left: 20px">
                            <b style="color:#F57C00">Rank</b>
                        </div>
                        <div class="col-md-1 col-xs-3"  style="padding-left: 20px">

                        </div>
                        <div class='col-md-3 col-xs-3' style="padding-left:20px">
