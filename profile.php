    ...
    function generateCode(){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                else if(response.result_code == 205)
                {
                    $('#exampleModalLabel1').text("Oops...")
                    $("#result").html("<h4>Service temporarily down. Please try again in sometime.</h4>")
                }
                else if(response.result_code == 206)
                {
                    $('#exampleModalLabel1').text("Oops...")
                    $("#result").html("<h4>You have no referrals left. Please go to the redeem section to purchase more referrals.</h4>")
                }
                else
                {
                    $('#exampleModalLabel1').text("Oops...")
                ...
                <div class="user-dashboard">
                    ...
                    <div class="row">
                        <div class="col-md-7 col-sm-7 col-xs-12 gutter">
                            <div class="card">
                                ...
                                <div class="halfRight">
                                    ...
                                    <p class="profile_card">
                                        ...
                                        <br />
                                        <i class="glyphicon glyphicon-gift"></i>Points: <a href='Help.php#points'><b><u style="color:#F57C00"><span id="points" style="color:#F57C00"></span></u></b></a>
                                    </p>
                                </div>
                                <div class="btn-group">
                            ...
                            <div class="card">
                                <a href="Help.php#bt"> <h2>Badges and Trophies</h2></a>
                                <div id="badges">
